    ...
    <body>
        ...
        <div class="pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a
                        href="<?php echo U('addShop2');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a></if></span>
            </div>
            <div class="mt-20">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <?php if(is_array($data['List'])): $i = 0; $__LIST__ = $data['List'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                            ...
                            <td><?php echo ($vo["renshu"]); ?>&nbsp;&nbsp;&nbsp;
                                <a title="查看" href="<?php echo U('seeren',array('id'=>$vo['id']));?>" class="ml-5"
                                               style="color: #0B61A4">查看</a>
                            </td>
                            <td><?php echo ($vo["sort"]); ?></td>
                            <td><?php echo (date('Y-m-d H:i:m',$vo["time"])); ?></td>
                            <td class="td-manage">
                                <a title="编辑" href="<?php echo U('editShop2',array('id'=>$vo['id']));?>" class="ml-5"
                                   style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                                <a title="删除" href="<?php echo U('delShop2',array('id'=>$vo['id']));?>" class="ml-5"
                                   style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                            </td>
