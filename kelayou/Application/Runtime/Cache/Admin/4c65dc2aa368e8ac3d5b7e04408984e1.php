...
<div class="pd-20">
   ...
   <!-- <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><?php if($module['picture']['add']): ?><a
            href="<?php echo U('add');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a><?php endif; ?></span>
    </div>-->
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    ...
                    <td><img src="<?php echo ($vo["path"]); ?>" alt="<?php echo ($vo["name"]); ?>" width="100" height="80"></td>
                    <td class="td-manage">
                        <?php if($module['picture']['edit']): ?><a title="编辑" href="<?php echo U('edit',array('id'=>$vo['id']));?>" class="ml-5"
                           style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a><?php endif; ?>
                        <!--<?php if($module['picture']['del']): ?><a title="删除" href="<?php echo U('del',array('id'=>$vo['id']));?>" class="ml-5"
                           style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a><?php endif; ?>--></td>
