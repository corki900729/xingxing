...
<!-- brand 品牌列表-->
<div class="news-box bra-box">
    <h1 class="wow fadeInDown animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">品牌中心<br><span>Brand center</span></h1>
    <div class="bra-list">
        <?php if(is_array($List)): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Brand/brandInfo/'.$vo['id']);?>">
            <img class="bra-wh" src="<?php echo ($vo["logo"]); ?>" alt="<?php echo ($vo["name"]); ?>">
            <img class="bra-bl" src="<?php echo ($vo["logo2"]); ?>" alt="<?php echo ($vo["name"]); ?>">
