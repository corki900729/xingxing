...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 岗位管理 <a
...
<div class="pd-20">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a
                href="<?php echo U('addJob',array('flg'=>$flg));?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加岗位</a></if></span>
    </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tbody>
                <?php if(is_array($data['List'])): $i = 0; $__LIST__ = $data['List'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c" >
                    <td><?php echo (htmlspecialchars_decode($vo["job"])); ?></td>
                    <td><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["zhize"])),0,200,'utf-8')); ?></td>
                    <td><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["zige"])),0,200,'utf-8')); ?></td>
                    <td><img width="130" height="80" src="<?php echo ($vo["image"]); ?>"/></td>
                    <td class="td-manage">
                        <a title="编辑" href="<?php echo U('editJob',array('id'=>$vo['id'],'flg'=>$flg));?>" class="ml-5"
                           style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                           <a title="删除" href="<?php echo U('delJob',array('id'=>$vo['id'],'flg'=>$flg));?>" class="ml-5"
                           style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                    </td>
