...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> VIP文章管理 <a
...
<div class="pd-20">
    ...
    <!--<div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a
            href="<?php echo U('addVip');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加VIP文章</a></if></span>
    </div>-->
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                <th width="100">标题</th>
                <th width="150">如何办卡</th>
                <th width="150">持卡礼遇</th>
                <th width="150">图片</th>
                <th width="150">注</th>
                <th width="100">操作</th>
            </tr>
            ...
            <tbody>
                <tr class="text-c" style="  background-color:#C8F1FF; ">
                    ...
                    <td><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($data['oneList']["how"])),0,200,'utf-8')); ?></td>
                    <td><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($data['oneList']["liyu"])),0,200,'utf-8')); ?></td>
                    <td><img width="130" height="80" src="<?php echo ($data['oneList']["image"]); ?>"/></td>
                    <td><?php echo ($data['oneList']["zhu"]); ?></td>
                    <td class="td-manage">
                        <a title="编辑" href="<?php echo U('editVip',array('id'=>$data['oneList']['id']));?>" class="ml-5"
            ...
            <?php if(is_array($data['List'])): $i = 0; $__LIST__ = $data['List'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    ...
                    <td class="td-manage">
                        <a title="编辑" href="<?php echo U('editVip',array('id'=>$vo['id']));?>" class="ml-5"
                           style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    </td>
