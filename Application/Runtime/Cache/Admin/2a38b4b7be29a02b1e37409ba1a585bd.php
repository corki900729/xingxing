...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 品牌管理 <a
...
<div class="pd-20">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a
            href="<?php echo U('addBrand');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加品牌</a></if></span>
    </div>-->
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <?php if(is_array($data['List'])): $i = 0; $__LIST__ = $data['List'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    ...
                    <td style="background-color: #BCBCBC"><img width="130" height="80" src="<?php echo ($vo["logo"]); ?>"/></td>
                    <td><?php echo ($vo["sort"]); ?></td>
                    <td class="td-manage">
                        <a title="编辑" href="<?php echo U('editBrand',array('id'=>$vo['id']));?>" class="ml-5"
